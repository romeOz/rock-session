 ...
 * The collection name can be changed by setting {@see \rock\session\MongoSession::$sessionCollection}.
 *
 ...
 * ```php
 * 'session' => [
 *     'class' => 'rock\session\MongoSession',
...
class MongoSession extends Session
{
     ...
     * @throws InstanceException if {@see \rock\mongodb\Session::$connection} is invalid.
     */
